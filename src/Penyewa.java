...
public class Penyewa extends javax.swing.JFrame {
    ...
    String idpenyewa, nmpenyewa,notlp, status;
    ...
    public Penyewa() {
        ...
        idpenyewa = tid.getText();
        nmpenyewa = tnama.getText();
        notlp = tno.getText();
        ...
        tno.setText(""+model.getValueAt(i,2));
        tstatus.setText(""+model.getValueAt(i,3));
    }
        public void reset(){
        idpenyewa = "";
        nmpenyewa = "";
        ...
        tid.setText(idpenyewa);
        tnama.setText(nmpenyewa);
        tno.setText(notlp);
   ...
   public void simpanDataPenyewa(){
        ...
        try{
            ...
            Statement stat = (Statement) Koneksi.getKoneksi().createStatement();
            String  sql =   "INSERT INTO tb_penyewa(id_penyewa, nm_penyewa, no_tlp, status)"
                            + "VALUES('"+ idpenyewa +"','"+ nmpenyewa +"','"+ notlp +"','"+ status +"')";
    ...
    public void rubahDataPenyewa(){
        ...
        try{
            Statement stat = (Statement) Koneksi.getKoneksi().createStatement();
            String sql  =   "UPDATE tb_penyewa SET nm_penyewa = '"+ nmpenyewa +"',"
                            + "no_tlp  = '"+ notlp +"',"
                            + "status  = '"+ status +"'"  
    ...
    public void hapusDataPenyewa(){
        ...
        if(pesan == JOptionPane.OK_OPTION){
            ...
            try{
                ...
                String sql = "DELETE FROM tb_penyewa WHERE id_penyewa='"+ idpenyewa +"'";
                PreparedStatement p =(PreparedStatement)Koneksi.getKoneksi().prepareStatement(sql);
                p.executeUpdate();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(tstatus, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
